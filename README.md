...
- **Audio Notification**: Pleasant 4-note chime when a timer completes
...
6. Click **Reset** to clear the timer and enter a new time
7. Click **Remove** to delete a timer and free up a slot
